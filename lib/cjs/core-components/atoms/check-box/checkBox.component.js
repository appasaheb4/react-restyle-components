...
const CheckBox = ({ title = 'Banks', data = [{ title: 'SBI Bank', checked: false }], className, onChange, }) => {
    ...
    const width = 20;
    return (react_1.default.createElement(form_component_1.InputWrapper, { label: title }, list === null || list === void 0 ? void 0 : list.map((item, index) => (react_1.default.createElement("div", { className: `${className} flex flex-row  items-center `, onClick: () => {
        ...
        react_1.default.createElement("span", null, item === null || item === void 0 ? void 0 : item.title))))));
};
