...
const DatePickerComp = ({ className, disable, value, showFormat = 'yyyy-MM-dd', placeholder = 'Select Date', }) => {
    ...
    const CustomInput = (0, react_1.forwardRef)((props, ref) => {
        return (react_1.default.createElement("div", { onClick: !disable && props.onClick, ref: ref, className: " border-gray-light place-items-center  border rounded-md px-2 flex flex-wrap " },
            ...
            react_1.default.createElement(datePicker_svg_1.ReactComponent, { width: 15, height: 15 })));
    });
    CustomInput.displayName = 'CustomInput';
    const handleChanges = (date) => {
        setPickedDate(date);
    };
    return (react_1.default.createElement("div", { className: `${className}   items-center flex justify-start ` },
        react_1.default.createElement("div", { className: "flex-wrap" },
