...
const AutoCompleteFilterMultipleSelectMultipleFieldsDisplay = ({ uniqueField = '_id', loader = false, placeholder = 'Search...', data, hasError = false, disable = false, isUpperCase = false, name, onFilter, onUpdate, onSelect, onBlur, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { ref: wrapperRef, className: "w-full relative" },
            ...
            options && isListOpen
                ? (options === null || options === void 0 ? void 0 : options.length) > 0 && (react_1.default.createElement("div", { className: "mt-1  absolute bg-gray-100 p-2 rounded-sm z-500", style: { zIndex: 80 } },
                    react_1.default.createElement("ul", null, options === null || options === void 0 ? void 0 : options.map((item, index) => (react_1.default.createElement(react_1.default.Fragment, null,
