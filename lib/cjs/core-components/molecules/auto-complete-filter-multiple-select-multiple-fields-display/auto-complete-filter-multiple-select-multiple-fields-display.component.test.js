...
it("render AutoCompleteFilterMultipleSelectMultipleFieldsDisplay correctly", () => {
  const autoCompleteFilterMultipleSelectMultipleFieldsDisplay = (0,
  _core_utils_1.render)(
    react_1.default.createElement(
      auto_complete_filter_multiple_select_multiple_fields_display_component_1.AutoCompleteFilterMultipleSelectMultipleFieldsDisplay,
      {
        data: [],
        onUpdate: (item) => {
          console.log({ item });
