...
const CSSMultiline = ({ label = 'Main Box CSS', defaultValue = '', className = '', style = {}, placeholder = "Like fontSize: 12,backgroundColor:'#000000',", onChange, }) => {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col w-full", ref: wrapperRef },
        react_1.default.createElement(__1.Form.MultilineInput, { label: label, style: Object.assign({ color: '#ffffff', backgroundColor: '#000000' }, style), placeholder: placeholder, value: value.current, className: className, onKeyUp: onKeyUp, onChange: (css) => {
                value.current = css;
                filter(css);
            } }),
        isListOpen && (react_1.default.createElement("div", { style: { marginTop: -10 } },
            react_1.default.createElement("ul", { className: "flex flex-col max-h-40 bg-black  m-2 text-white  overflow-y-scroll  " }, properties === null || properties === void 0 ? void 0 : properties.map((item, index) => {
                var _a;
                return (react_1.default.createElement("li", { key: index, className: "flex flex-col gap-4 p-2" },
                    react_1.default.createElement("span", { className: "underline" }, item[0]), (_a = item[1]) === null || _a === void 0 ? void 0 :
                    _a.map((prop) => (react_1.default.createElement("li", { className: "flex -mt-2 px-2 h-8 bg-slate-800  rounded-md items-center cursor-pointer", onClick: () => {
                            var _a;
