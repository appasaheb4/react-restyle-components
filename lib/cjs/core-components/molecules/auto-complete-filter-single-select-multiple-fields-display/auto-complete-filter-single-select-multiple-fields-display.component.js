        ...
        react_1.default.createElement("div", { ref: wrapperRef, className: "w-full relative" },
            ...
            options && isListOpen
                ? options.length > 0 && (react_1.default.createElement("div", { className: `mt-1 absolute  w-full bg-gray-100 p-2 rounded-sm `, style: {
                    ...
                    react_1.default.createElement("ul", null, options === null || options === void 0 ? void 0 : options.map((item, index) => (react_1.default.createElement("li", { key: index, className: "text-gray-400 flex items-center", onClick: () => {
