...
export const DraggableSelectedItem = ({ item, index, onRemove, displayKey, uniqueField = 'sort', displayConfig = {}, sortableTransitionMs = 200, className, style: customStyle, }) => {
    const { attributes, listeners, setNodeRef, transform, transition, isDragging } = useSortable({
        id: item[uniqueField] || item.sort || index.toString(),
        transition: {
            duration: sortableTransitionMs,
...
export const AutoCompleteFilterMultiSelectMultiFieldsDisplayDragDrop = ({ componentKey, uniqueField = '_id', loader = false, placeholder = 'Search...', data, hasError = false, disable = false, isUpperCase = false, name, defaultValue = '', displayConfig = {}, dragDropConfig = {}, selectionConfig = {}, uiConfig = {}, onFilter, onUpdate, onSelect, onBlur, className, style, filterDebounceDelay = 1000, }) => {
    ...
    const { showSelectedSection = true, selectedPlaceholder, emptyStateMessage = 'No items available', maxHeight = 'min(72vh, 22rem)', zIndex = 80, } = uiConfig;
    ...
    return (_jsx(_Fragment, { children: _jsxs("div", { ref: wrapperRef, className: cn(s['w-full'], s['relative'], className), style: style, children: [_jsxs("div", { className: cn(s['flex'], s['items-center'], s['leading-4'], s['p-2'], s['focus:outline-none'], s['focus:ring'], s['w-full'], s['shadow-sm'], s['sm:text-base'], s['border'], s['rounded-md'], {
                        ...
                        pointerEvents: dropdownEntered ? 'auto' : 'none',
                            ...
                            }, children: _jsx("ul", { className: cn(s['flex'], s['flex-col'], s['gap-0'], s['m-0'], s['list-none'], s['p-1'], s['w-full']), id: componentKey ? `${componentKey}_listView` : undefined, children: options.map((item, index) => (_jsx("li", { className: cn(s['flex'], s['rounded-md'], s['transition-colors'], s['duration-300'], s['hover:bg-gray-100']), children: _jsxs("label", { className: cn(s['flex'], s['cursor-pointer'], s['items-start'], s['gap-3'], s['w-full'], s['py-2'], s['px-2']), children: [_jsx("input", { className: cn(s['h-4'], s['w-4']), style: { flexShrink: 0, marginTop: 2 }, type: "checkbox", checked: item.selected || false, onChange: () => handleSelectItem(item), disabled: maxSelection
                                                    ? selectedItems.length >= maxSelection &&
                                                        !item.selected
