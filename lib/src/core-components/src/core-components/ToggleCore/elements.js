...
`;
export const CheckboxToggle = ({ ...props }) => (_jsxs(StyledCheckbox, { ...props, children: [_jsx(StateLayer, {}), _jsx(Icon, { nameIcon: "IoIosCheckmarkCircleOutline" }), _jsx(Icon, { nameIcon: "FaMinusCircle" })] }));
