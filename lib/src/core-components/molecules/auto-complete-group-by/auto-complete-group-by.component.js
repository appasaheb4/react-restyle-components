...
export const AutocompleteGroupBy = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { ref: wrapperRef, className: "w-full relative" },
            ...
            options && isListOpen
                ? options?.length > 0 && (React.createElement("div", { className: "flex mt-1 absolute z-50  rounded-md bg-gray-200 w-100 w-full" },
                    React.createElement("ul", { className: "flex p-2 rounded-sm w-full" },
                        React.createElement("div", { className: "flex flex-col w-full overflow-scroll", style: { height: 'auto', maxHeight: '350px' } }, options?.map((item, index) => (React.createElement(React.Fragment, null,
                            React.createElement("li", { key: index, className: "flex text-gray-400" }, item.title),
                            React.createElement("ul", { className: "flex flex-col ml-4 w-full" }, item?.children?.map((children, childrenIndex) => (React.createElement("li", { key: childrenIndex, className: "flex hover:bg-gray-200 focus:outline-none cursor-pointer w-full", onClick: async () => {
                                    props.onChange &&
