...
export default ({ value = '', onValueChange, options = [], }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("input", { type: "text", role: "input", name: "autocomplete-input", onChange: onInputChange, onKeyDown: onKeyDown, value: searchValue, ref: inputRef }),
        renderList()));
};
