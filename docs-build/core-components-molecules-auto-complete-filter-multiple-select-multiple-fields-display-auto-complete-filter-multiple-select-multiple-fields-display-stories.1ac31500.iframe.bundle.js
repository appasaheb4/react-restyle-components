      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.r(__webpack_exports__),
          __webpack_require__.d(__webpack_exports__, {
            ...
            default: () =>
              auto_complete_filter_multiple_select_multiple_fields_display_stories,
          });
        ...
        var AutoCompleteFilterMultipleSelectMultipleFieldsDisplay = function (
          param,
        ) {
          var ref,
            _param_uniqueField = param.uniqueField,
            uniqueField =
              void 0 === _param_uniqueField ? "_id" : _param_uniqueField,
            _param_placeholder = (param.loader, param.placeholder),
            placeholder =
            ...
            _param_isUpperCase = param.isUpperCase,
            isUpperCase = void 0 !== _param_isUpperCase && _param_isUpperCase,
            name = param.name,
            onFilter = param.onFilter,
            ...
            _useState2 = _sliced_to_array((0, react.useState)(), 2),
            originalOptions = _useState2[0],
            setOriginalOptions = _useState2[1],
            _useState3 = _sliced_to_array((0, react.useState)(!1), 2),
            isListOpen = _useState3[0],
            setIsListOpen = _useState3[1],
          ...
          var count = 0,
            getSelectedItem = function (selectedItem, list) {
              if (0 === count) {
                var finalList =
                  null == list
                    ? void 0
                    : list.filter(function (item, index) {
                        return (
                          ...
                          selectedItem && selectedItem.length > 0
                            ? selectedItem.find(function (sItem, index) {
          ...
          return react.createElement(
            ...
            react.createElement(
              ...
              options && isListOpen
                ? (null == options ? void 0 : options.length) > 0 &&
                    react.createElement(
                      "div",
                      {
                        className:
                          "mt-1  absolute bg-gray-100 p-2 rounded-sm z-500",
                        style: { zIndex: 80 },
                      },
                      react.createElement(
                        "ul",
        ...
        const auto_complete_filter_multiple_select_multiple_fields_display_stories =
          {
            title:
