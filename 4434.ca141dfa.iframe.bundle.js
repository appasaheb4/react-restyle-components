...
`,ToolbarButton=styled_components_browser_esm.I4.button`
  ...
  font-size: 13px;
  font-weight: 500;
  color: ${({$active})=>$active?"white":designTokens.L.onSurface||"#374151"};
  background: ${({$active})=>$active?designTokens.L.primary||"#3b82f6":"white"};
  border: 1px solid ${({$active})=>$active?"transparent":designTokens.L.outline||"#d1d5db"};
  border-radius: 6px;
  cursor: pointer;
  ...
  &:hover:not(:disabled) {
    background: ${({$active})=>$active?designTokens.L.primary||"#2563eb":designTokens.L.surface||"#f3f4f6"};
  }
...
`,StyledTable=styled_components_browser_esm.I4.table`
  ...
  ${({$hover})=>$hover&&styled_components_browser_esm.AH`
      tbody tr:hover {
        background: ${designTokens.L.primary?`${designTokens.L.primary}08`:"#f0f9ff"};
        color: ${designTokens.L.onSurface||"#1f2937"};
      }
    `}
...
`,HeaderRow=styled_components_browser_esm.I4.tr`
  background: ${designTokens.L.surface||"#6b7280"};
`,HeaderCell=styled_components_browser_esm.I4.th`
  ...
  color: white;
  background: #6b7280;
  border-bottom: 2px solid ${designTokens.L.outline||"#e5e7eb"};
  white-space: nowrap;
  user-select: none;
  ...
  ${({$sortable})=>$sortable&&styled_components_browser_esm.AH`
      cursor: pointer;
      padding-right: 32px;
  ...
  ${({$pinned})=>$pinned&&styled_components_browser_esm.AH`
      position: sticky;
      ${$pinned}: 0;
      z-index: 11;
    `}
...
`,PageButton=styled_components_browser_esm.I4.button`
  ...
  border: 1px solid ${({$active})=>$active?"transparent":"rgba(255,255,255,0.3)"};
  border-radius: 4px;
  cursor: pointer;
  transition: all 0.15s ease;
...
`,EditableCell=styled_components_browser_esm.I4.div`
  ...
  ${({$editing})=>!$editing&&styled_components_browser_esm.AH`
      &:hover::after {
        content: '✏️';
        position: absolute;
        right: -4px;
...
`,FilterInputBase=styled_components__WEBPACK_IMPORTED_MODULE_2__.I4.input`
  ...
  &::placeholder {
    color: ${_utils_designTokens__WEBPACK_IMPORTED_MODULE_1__.L.onSurface?`${_utils_designTokens__WEBPACK_IMPORTED_MODULE_1__.L.onSurface}40`:"#9ca3af"};
  }
`,FilterSelectBase=styled_components__WEBPACK_IMPORTED_MODULE_2__.I4.select`
  width: 100%;
  height: 28px;
  padding: 0 8px;
  font-size: 12px;
...
`,ComparatorSelect=styled_components__WEBPACK_IMPORTED_MODULE_2__.I4.select`
  width: 50px;
  height: 28px;
  padding: 0 4px;
  font-size: 11px;
...
`,DateInput=styled_components__WEBPACK_IMPORTED_MODULE_2__.I4.input`
  flex: 1;
  height: 28px;
  padding: 0 8px;
  font-size: 12px;
...
`,ToggleButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.I4.button`
  height: 28px;
  padding: 0 8px;
  font-size: 11px;
  font-weight: 500;
  ...
  ${({$active})=>$active?styled_components__WEBPACK_IMPORTED_MODULE_2__.AH`
